...
// Verify the order belongs to the user and is in 'completed' status
...
if ($row = $result->fetch_assoc()) {
    ...
    $update_stmt = $conn->prepare("UPDATE publication_orders SET status = 'return_requested' WHERE id = ?");
