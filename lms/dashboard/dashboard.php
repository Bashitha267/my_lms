...
while ($row = $result->fetch_assoc()) {
    ...
    // Get teacher assignments (subjects and streams they're teaching)
...
<body class="bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                <h1 class="text-3xl font-bold text-gray-900 mb-4">Teachers</h1>
    ...
    <script>
                        ...
                        data.enrollments.forEach(enrollment => {
                            html += `
                                <div class="border border-gray-300 rounded-lg p-4 hover:shadow-md transition-shadow">
                                    <h4 class="font-bold text-lg text-gray-900 mb-2">${enrollment.subject_name || 'Subject'}</h4>
        ...
        function enrollStudent(teacherAssignmentId, streamSubjectId, academicYear) {
            ...
            formData.append('stream_subject_id', streamSubjectId);
