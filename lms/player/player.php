    ...
    <style>
        * {
        ...
        @media (max-width: 768px) {
            ...
            /* Hide sidebar from its original position */
            .videos-sidebar {
    ...
    <?php else: ?>
        <div class="player-container">
            ...
            <div class="videos-sidebar">
                ...
                <div class="videos-sidebar-content">
                    ...
                    <?php else: ?>
                        <!-- Current Video (at top) -->
                        <div class="video-item active">
                            <img src="<?php echo htmlspecialchars($current_recording['thumbnail_url']); ?>" 
                                 alt="<?php echo htmlspecialchars($current_recording['title']); ?>"
                                 class="video-item-thumbnail"
                                 onerror="this.src='https://img.youtube.com/vi/<?php echo htmlspecialchars($current_recording['youtube_video_id']); ?>/hqdefault.jpg'">
                            <div class="video-item-info">
                                <div class="video-item-title"><?php echo htmlspecialchars($current_recording['title']); ?></div>
                                <div class="video-item-date">
                                    <i class="far fa-clock mr-1"></i>
                                    <?php echo date('M d, Y', strtotime($current_recording['created_at'])); ?>
                                </div>
                            </div>
                        </div>
            ...
            <div class="player-main">
                ...
                <div class="mobile-videos-section">
                    ...
                    <div class="mobile-videos-scroll">
                        ...
                        <?php else: ?>
                            <!-- Current Video -->
                            <div class="mobile-video-item active">
                                <img src="<?php echo htmlspecialchars($current_recording['thumbnail_url']); ?>" 
                                     alt="<?php echo htmlspecialchars($current_recording['title']); ?>"
                                     class="mobile-video-thumbnail"
                                     onerror="this.src='https://img.youtube.com/vi/<?php echo htmlspecialchars($current_recording['youtube_video_id']); ?>/hqdefault.jpg'">
                                <div class="mobile-video-info">
                                    <div class="mobile-video-title"><?php echo htmlspecialchars($current_recording['title']); ?></div>
        ...
        <script>
            ...
            document.addEventListener('touchmove', function(e) {
                // Allow scrolling only in sidebar, video-info, and mobile-videos-scroll
