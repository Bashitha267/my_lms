...
$stmt = $conn->prepare("SELECT setting_key, setting_value FROM system_settings WHERE setting_key IN ('dashboard_background', 'recordings_background', 'live_classes_background')");
$stmt->execute();
$result = $stmt->get_result();
        ...
        <div class="px-4 py-6 sm:px-0">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="border-t pt-6">
                    <h3 class="text-xl font-semibold text-gray-800 mb-4">Additional Settings</h3>
                    <p class="text-gray-600">More system settings will be available here in future updates.</p>
                </div>
            </div>
        </div>
    </div>
