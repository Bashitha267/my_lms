...
// Build query
$query = "SELECT user_id, username, email, role, first_name, second_name, mobile_number, whatsapp_number, status, approved, registering_date FROM users WHERE 1=1";
$params = [];
$types = '';
...
if (!empty($search)) {
    $query .= " AND (username LIKE ? OR email LIKE ? OR first_name LIKE ? OR second_name LIKE ? OR user_id LIKE ?)";
    $search_param = "%$search%";
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                <form method="GET" action="" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select id="filter" name="filter" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500">
                    ...
                    <div>
                        ...
                        <select id="approved" name="approved" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500">
                    ...
                    <div class="md:col-span-4 flex justify-end space-x-2">
                        ...
                        <a href="users.php" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50">
                            Clear
                        </a>
                    </div>
                </form>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-red-600">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Username</th>
